...
type HostPoolStatus struct {
	state                 protoimpl.MessageState      `protogen:"opaque.v1"`
	xxx_hidden_State      HostPoolState               `protobuf:"varint,1,opt,name=state,proto3,enum=osac.public.v1.HostPoolState"`
...
type HostPoolCondition struct {
	state                         protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Type               HostPoolConditionType  `protobuf:"varint,1,opt,name=type,proto3,enum=osac.public.v1.HostPoolConditionType"`
