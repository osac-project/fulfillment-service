...
var filter_ConsoleSessions_Create_0 = &utilities.DoubleArray{Encoding: map[string]int{"object": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_ConsoleSessions_Create_0(ctx context.Context, marshaler runtime.Marshaler, client ConsoleSessionsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ConsoleSessions_Create_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
