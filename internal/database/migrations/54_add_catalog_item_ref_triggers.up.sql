...
-- Attach the trigger so that it fires on insert or update of active clusters:
create trigger check_cluster_catalog_item_ref
...
-- Attach the trigger so that it fires on insert or update of active compute instances:
create trigger check_ci_catalog_item_ref
