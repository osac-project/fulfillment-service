...
// Make sure that we implement the interface.
var _ publicv1.HostsServer = (*HostsServerFuncs)(nil)
...
type HostsServerFuncs struct {
	...
	CreateFunc func(context.Context, *publicv1.HostsCreateRequest) (*publicv1.HostsCreateResponse, error)
	DeleteFunc func(context.Context, *publicv1.HostsDeleteRequest) (*publicv1.HostsDeleteResponse, error)
	GetFunc    func(context.Context, *publicv1.HostsGetRequest) (*publicv1.HostsGetResponse, error)
	ListFunc   func(context.Context, *publicv1.HostsListRequest) (*publicv1.HostsListResponse, error)
	UpdateFunc func(context.Context, *publicv1.HostsUpdateRequest) (*publicv1.HostsUpdateResponse, error)
}
...
// Make sure that we implement the interface.
var _ publicv1.HostPoolsServer = (*HostPoolsServerFuncs)(nil)
...
type HostPoolsServerFuncs struct {
	...
	CreateFunc func(context.Context, *publicv1.HostPoolsCreateRequest) (*publicv1.HostPoolsCreateResponse, error)
	DeleteFunc func(context.Context, *publicv1.HostPoolsDeleteRequest) (*publicv1.HostPoolsDeleteResponse, error)
	GetFunc    func(context.Context, *publicv1.HostPoolsGetRequest) (*publicv1.HostPoolsGetResponse, error)
	ListFunc   func(context.Context, *publicv1.HostPoolsListRequest) (*publicv1.HostPoolsListResponse, error)
	UpdateFunc func(context.Context, *publicv1.HostPoolsUpdateRequest) (*publicv1.HostPoolsUpdateResponse, error)
}
